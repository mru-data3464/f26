...
paginate: true
headingDivider: 2
demo-code: "/demo_code/02_models/model_demo.ipynb"
demo-data: ""
leftoff: "Slide 17"
---
...
**Resources used**:
- [Feature Engineering Chapter 1](https://feat.engineering/01-introduction.html)
...
<footer>Further reading: https://feat.engineering/01-introduction.html#sec-no-free-lunch</footer>
...
<!-- Example time -->
<!-- Cilantro: truth = 80 / 100 -->
<!-- - Predicted: TP = 75, TN = 10, FN = 5, FP = 10 -->
...
* Better for unbalanced datasets, but still does not capture specificity
...
* Coefficient of determination: $R^2 = 1 - \frac{\sum_{i=1}^n (y_i - \hat{y}_i)^2}{\sum_{i=1}^n (y_i - \bar{y})^2}$
  ($R^2$ has some [caveats](https://feat.engineering/03-Review_of_the_Modeling_Process.html#sec-measuring-performance))
...
![center h:400px](../img/02-tree_regression.png)
...
![](../img/02-ram.png)
Price of DDR5-5600 2X32GB RAM since March 2025 [[PCPartPicker](https://pcpartpicker.com/trends/price/memory/#ram.ddr5.5200.2x16384)]
...
## <!-- fit --> Lecture ends here

<!-- _class: title_slide -->

In the interest of time, we're going to skip over unsupervised clustering for now. We'll revisit if time allows later in the semester.
